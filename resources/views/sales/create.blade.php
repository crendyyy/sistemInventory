        ...
        <div class="p-6 text-gray-900 dark:text-gray-100" 
            ...
            <form method="POST" action="{{ route('sales.store') }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <!-- Customer -->
                    <div>
                        <label class="block font-medium text-sm text-gray-700 dark:text-gray-300">Customer <span class="text-red-500">*</span></label>
                    ...
                    <!-- Date -->
                    <div>
                        <label class="block font-medium text-sm text-gray-700 dark:text-gray-300">Tanggal Penjualan <span class="text-red-500">*</span></label>
                ...
                <div class="mb-8 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
                    ...
                    <div class="p-4 space-y-4">
                        <template x-for="(item, index) in items" :key="item.id">
                            <div class="flex flex-col md:flex-row items-end gap-4 p-4 border border-green-100 dark:border-green-900/30 rounded-lg bg-green-50/30 dark:bg-green-900/10">
                                ...
                                <div class="w-full md:w-5/12">
                                    ...
                                    <select x-model="item.product_id" :name="`items[${index}][product_id]`" @change="productChanged(item)" required class="block w-full text-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm">
                                        ...
                                        <template x-for="p in availableProducts" :key="p.id">
                                            <option :value="p.id" x-text="p.name + ` (Stok: ${p.stock})`" :disabled="p.stock <= 0"></option>
                                        </template>
                                    </select>
                                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg space-y-4 border border-gray-200 dark:border-gray-600">
                        <div class="flex justify-between items-center pb-4 border-b border-gray-300 dark:border-gray-600">
                            <span class="text-gray-700 dark:text-gray-300 font-medium text-lg">Total Penjualan</span>
                        ...
                        <div>
                            ...
                            <p class="text-xs mt-2" :class="amountPaid < calculateTotal() ? 'text-red-500' : 'text-green-600 dark:text-green-400'">
                                <span x-show="amountPaid < calculateTotal()">Kekurangan: <span x-text="'Rp ' + formatMoney(calculateTotal() - amountPaid)"></span> (Piutang)</span>
                ...
                <div class="flex justify-end gap-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                    <a href="{{ route('sales.index') }}" class="inline-flex items-center px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase shadow-sm hover:bg-gray-50 dark:text-gray-300">Batal</a>
