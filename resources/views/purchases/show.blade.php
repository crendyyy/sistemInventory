        ...
        <div class="md:col-span-2">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <form action="{{ route('purchases.payment', $purchase) }}" method="POST" class="space-y-4">
                        @csrf
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-1">Sisa hutang: <span class="font-semibold text-red-600">Rp {{ number_format($purchase->remaining, 0, ',', '.') }}</span></p>
                            </div>
                            <div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-3 space-y-2">
                            <div class="flex justify-between text-sm">
                                ...
                                <span class="font-medium text-gray-900 dark:text-white">Rp {{ number_format($purchase->total, 0, ',', '.') }}</span>
                            </div>
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-500 dark:text-gray-400">Dibayar</span>
                                <span class="font-medium text-green-600 dark:text-green-400">Rp {{ number_format($purchase->paid_amount, 0, ',', '.') }}</span>
                            </div>
                            @if($purchase->remaining > 0)
                            <div class="flex justify-between text-sm border-t border-gray-200 dark:border-gray-600 pt-2">
                                <span class="text-gray-500 dark:text-gray-400 font-medium">Sisa Hutang</span>
                                <span class="font-bold text-red-600 dark:text-red-400">Rp {{ number_format($purchase->remaining, 0, ',', '.') }}</span>
                            </div>
                            @endif
                        </div>
                        <div>
