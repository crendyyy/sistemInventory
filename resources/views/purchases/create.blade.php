                        ...
                        <template x-for="(item, index) in items" :key="item.id">
                            <div class="flex flex-col md:flex-row items-end gap-4 p-4 border border-blue-100 dark:border-blue-900/30 rounded-lg bg-blue-50/30 dark:bg-blue-900/10">
                                ...
                                <div class="w-full md:w-2/12">
                                    ...
                                    <input type="number" x-model.number="item.quantity" :name="`items[${index}][quantity]`" required min="1" class="block w-full text-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm">
                                </div>
